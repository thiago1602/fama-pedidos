                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($bairros as $bairro): ?>
                            <tr>
                                ...
                                <td><?php echo ($bairro->ativo && $bairro->deletado_em == null ? '<label class="badge badge-primary">Sim</label>' : '<label class="badge badge-primary">Não</label>'); ?></td>

                                <td>
                                    <?php echo ($bairro->deletado_em == null ? '<label class="badge badge-primary">Disponivel</label>' : '<label class="badge badge-primary">Excluido</label>'); ?>

                                    <?php if ($bairro->deletado_em != null): ?>

                                        <a href="<?php echo site_url("admin/bairros/desfaserexclusao/$bairro->id");?>" class="badge badge-dark ml-2">
