                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php echo ($entregador->ativo && $entregador->deletado_em == null ? '<label class="badge badge-primary">Sim</label>' : '<label class="badge badge-primary">Não</label>'); ?></td>

                            <td>
                                <?php echo ($entregador->deletado_em == null ? '<label class="badge badge-primary">Disponivel</label>' : '<label class="badge badge-primary">Excluido</label>'); ?>

                                <?php if ($entregador->deletado_em != null): ?>

                                    <a href="<?php echo site_url("admin/entregadores/desfaserexclusao/$entregador->id");?>" class="badge badge-dark ml-2">
