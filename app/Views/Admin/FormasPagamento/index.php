                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php echo ($forma->ativo && $forma->deletado_em == null ? '<label class="badge badge-primary">Sim</label>' : '<label class="badge badge-primary">Não</label>'); ?></td>

                            <td>
                                <?php echo ($forma->deletado_em == null ? '<label class="badge badge-primary">Disponivel</label>' : '<label class="badge badge-primary">Excluido</label>'); ?>

                                <?php if ($forma->deletado_em != null): ?>

                                    <a href="<?php echo site_url("admin/formas/desfaserexclusao/$forma->id");?>" class="badge badge-dark ml-2">
