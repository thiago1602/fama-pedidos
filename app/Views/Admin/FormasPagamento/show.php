        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-primary" role="alert">
                    ...
                    A forma de pagamento <strong> <?php echo esc($forma->nome);?> </strong> não pode ser <span class="text-danger">
                        editada ou excluida
                    </span>,
                    pois essa opção será vinculada ao envio ou não de troco para o cliente,
                ...
                <div class="mt-4">
                    ...
                    <?php if ($forma->deletado_em == null): ?>
                        ...
                        <?php if ($forma->id != 1): ?>
                            ...
                            <a href="<?php echo site_url("admin/formas/excluir/$forma->id");?>" class="btn btn-danger btn-sm ">
                        ...
                        <a href="<?php echo site_url("admin/formas");?>" class="btn btn-light text-dark btn-sm mr-2 ">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo site_url("admin/formas/desfaserexclusao/$forma->id");?>" class="btn btn-dark btn-sm">
