...
<html lang="zxx" dir="ltr">
    ...
    <head>
        ...
        <title>Famagas Marilia | <?php echo $this->renderSection('titulo') ?></title>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
                    ...
                    <div class="navbar-container" data-spy="affix" data-offset-top="400">
                        <div class="container">
                            ...
                            <div class="navbar_top hidden-xs">
                                <div class="top_addr">
                                    <span><i class="fa fa-map-marker" aria-hidden="true"></i> Distrito Industrial, R. Maria Batistão, 50</span>
                                   <span><i class="fa fa-phone" aria-hidden="true"></i> (14) 3415-1737</span>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <div class="footer_border">
                                            <div class="footer_cnt">
                                                ...
                                                <span>Rua: Maria Batistão, 50 - Distrito Industrial</span>
                                            </div>
                                            <div class="footer_cnt">
                                                <i class="fa fa-phone"></i>
                                                <span>(14) 3415-1737</span>
                                            </div>
                                            <div class="footer_cnt">
                                                <i class="fa fa-envelope"></i>
                                                <span>famagasmarilia@gamail.com</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <nav class="cd-nav-container right_menu" id="cd-nav">
            <div class="header__open_menu">
                <a href="<?php echo site_url('/'); ?>" class="rmenu_logo" title="Famagas Marilia">
                    <img src="<?php echo site_url('web/'); ?>src/assets/img/logo.png" alt="logo" />
                </a>
            </div>
            ...
            <div class="right_menu_addr top_addr">
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Distrito Industrial, R. Maria Batistão, 50</span>
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Jd. Monte Castelo, R. Itororó, 23</span>
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Vila Hípica, R. Luis Felipe de Mello Filho, 50</span>
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Jd. Maria Izabel, R. Santa Helena, 275</span>
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Vila Jardim, R. José Silva, 642</span>
